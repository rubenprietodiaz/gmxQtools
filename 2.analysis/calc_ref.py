...
output_filename_rmsd = 'rmsd_results.txt'
output_filename_rmsf = 'rmsf_results.txt'
...
def calculations(value_type, traj, ref_traj):
...
def statistics (value_type, traj, ref_traj):
...
for subdir in os.listdir('.'):
    ...
    # Calculate RMSF
    rmsf_values = md.rmsf(traj, ref_traj, 0) * 10 # Convert to Angstrom
