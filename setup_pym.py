...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Script to process ligand files and create pymemdyn.sh for different clusters.")
...
# Loop through all .pdb files in the current directory, excluding protein.pdb
for file in os.listdir('.'):
    if file.endswith('.pdb') and file != 'protein.pdb':
        ...
        # Concatenate protein.pdb and LIG.pdb to create complex.pdb
